  ...
  return (
    <>
      ...
      <UseCase
        ...
        defense="This is basic AI integration failure: no URL allow-listing, no human approval gate, no trust tier for externally-editable config values. The fallback login URL is a setting anyone could change, and a critical error severity label does not make it trustworthy. These are the guardrails any enterprise should have before wiring an AI agent to production logs."
      />
