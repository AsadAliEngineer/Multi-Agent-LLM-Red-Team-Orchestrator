...
export default function Lesson() {
    ...
    <>
      ...
      <Comparison
        ...
        right={{
          ...
          points: [
            "Review instructions given to the AI before launch, with no blanket 'include all links' phrases",
      ...
      <p>The CISO owns the risk register and the policy mandate. Not the implementation, but the mandate that forces implementation to happen. Think of this like setting expense approval thresholds: the executive sets the policy, and the systems enforce it. The strategic question is not "can our AI be hacked?" It is: which public input surfaces does our AI read from, and do we have guardrails between those surfaces and our AI's write actions?</p>
      ...
      <DoDont
        do={[
          "Enforce write-scope contracts at the infrastructure level, so they are rejected by the system, not by the AI",
  ...
  nodes={[
    ...
    { type: "artifact", label: "Notion Deployment Guide", detail: "Attacker link written twice, as a checklist item and a blockquote" },
