...
export default function Lesson() {
  return (
    <>
      ...
      <FlowSteps
        steps={[
          ...
          },
          {
            icon: "lock",
            label: "Contain",
            desc: "Lock the affected document before anything else, to stop other AIs from reading it. Revoke the session access. Do not delete; preserve for investigation."
          },
          {
            icon: "cycle",
            label: "Rotate",
      ...
      <Callout type="danger" title="Immediate escalation: treat as active incident">
        An AI writes a link to a vendor list, payment instruction, identity record, or security guide that is not on the company's approved domain list. Any of these is an active incident, no matter whether the link looks suspicious.
      </Callout>
  ...
  nodes={[
    ...
    { type: "victim", label: "On-Call Engineers (all future)", detail: "Follow the link during incidents. The guide persists, so this is not a one-time compromise" },
  ]}
...
/>
      ...
      <DoDont
        do={[
          "Lock the document before any other action, to stop other AIs from reading it and spreading the problem",
