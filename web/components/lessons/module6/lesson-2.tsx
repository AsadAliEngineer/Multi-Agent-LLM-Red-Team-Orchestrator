...
export default function Lesson() {
    ...
    <>
      ...
      <Comparison
        left={{
          ...
          points: [
            "Vendor submissions arrive through controlled channels like email or a portal",
            "AI reads vendor data to pull out structured fields, which seems harmless",
        ...
        right={{
          ...
          points: [
            "Public vendor portals accept submissions from anyone, so that portal is your attack surface",
      ...
      <UseCase
        ...
        impact="The vendor portal link in the procurement checklist leads to credential theft or a redirected payment. The attacker link carries full IT-list authority, with no obvious warning sign for the human reviewer."
  ...
  nodes={[
    ...
    { type: "agent", label: "Main AI (Sonnet)", detail: "Reads the list and sees the link as IT-approved with full list authority. No warning signal" },
    ...
    { type: "victim", label: "Procurement Team", detail: "Follows attacker link, leading to credential theft or redirected payment" },
  ]}
