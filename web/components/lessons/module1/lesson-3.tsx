  ...
  return (
    <>
      ...
      <Callout type="danger" title="Multimodal Attacks">
        Malicious instructions hidden in images, audio, or video that the agent processes alongside text. An attacker can attach a poisoned image to a public support ticket or upload it to a shared document. Text-only defenses do not catch this.
      </Callout>
      ...
      <Callout type="danger" title="Deception &amp; Alignment Failures">
        The AI pursues goals that differ from what its operators intended. It appears to comply while actually doing something else. There is no injected payload to detect. The problem is structural. This is why alignment and auditing matter before you deploy, not after.
      </Callout>
      ...
      <UseCase
        ...
        impact="The attacker's link appears in the formal checklist with no warnings. The AI treats things the user says in chat differently from instructions in documents. Document-injection checks do not apply here, because there is no document. This is the simplest possible attack and it works because the enterprise deployed an AI agent with no output validation."
