...
export default function Lesson() {
  return (
    <>
      ...
      <AttackCard
        ...
        impact="Link added to a checklist as a factual action item. No warnings. The parent page also had to be renamed away from 'Red-Team Lab', because the tool returns page ancestry details and the AI reads that as a trust signal. That detail broke an earlier version of this attack."
      />
      ...
      <UseCase
        ...
        defense="This is what happens when an enterprise wires an AI agent to a public-facing code repo without input validation or a human approval step. Being on an approved list is not enough, because the list itself is something an attacker can edit via a normal PR. Verify domains through a separate channel before any endpoint goes into a runbook."
      />
  ...
  caption="MAA1+CONF1: A Haiku-to-Opus pipeline where the approved list launders the attacker's link"
/>
  ...
  caption="SL1: A Slack community attack where the AI's own 'include all links' instruction overrides its skepticism"
/>
