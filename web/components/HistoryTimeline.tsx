...
const MILESTONES: Milestone[] = [
  {
    ...
    body: "Built a research library of 1,205 sources covering every known way AI systems get tricked or attacked. It includes academic papers, industry reports, security blogs, and a public exploit database, all organized into ten clear categories.",
    outcome: "milestone",
    commit: "3da1a40",
  },
  {
  ...
  },
  {
    ...
    body: "First successful attack against Sonnet. We split malicious instructions across three innocent-looking documents. None was suspicious on its own. Together they pointed Sonnet to a fake vendor portal, and Sonnet recommended it confidently.",
    outcome: "attack-success",
    commit: "c23fe6f",
  },
  {
    ...
    body: "Second successful attack, with no malicious documents at all. In a casual conversation, a fake web address was mentioned as if it were common knowledge. A few sentences later, Sonnet repeated it as a real instruction in its own answer.",
    outcome: "attack-success",
    commit: "764787f",
  },
  {
