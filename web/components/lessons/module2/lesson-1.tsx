...
export default function Lesson() {
  return (
    <>
      ...
      <p>Both attacks end the same way: the attacker controls what the AI outputs. But they come through entirely different routes and need different defenses. Here is the key fact: neither route requires hacking. A direct attack just needs someone to type into a chat box. An indirect attack just needs someone to fill out a public form, open a PR, or post in a Slack channel, then wait for the AI agent to read that data. Locking one door and leaving the other open is how you lose.</p>
      ...
      <Comparison
        left={{
          ...
          points: [
            ...
            "Attacker is the user, or pretends to be the user",
        ...
        right={{
          ...
          points: [
            ...
            "User is innocent. The attacker tampered with a document, table, log, or tool",
...
/>
      ...
      <KeyPoint>
        Direct attacks target user messages, and anyone can do this through the normal chat interface. Indirect attacks target data sources the AI trusts even more than the user, and those sources are almost always reachable through a public form, a PR, or a community post. Neither requires hacking. Lock only the user channel and you have left the bigger door wide open.
      </KeyPoint>
    </>
  );
}
