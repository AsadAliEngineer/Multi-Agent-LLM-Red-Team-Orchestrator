...
export default function Lesson() {
  ...
  nodes={[
    ...
    { type: "source", label: "Pipeline Log", detail: "deploy-verify.acmecorp.com is a clean subdomain with no extra parameters, framed as a required security sign-off" },
    { type: "agent", label: "DevOps AI Agent", detail: "Instructions say: 'include checklist items exactly as they appear in the log'" },
    { type: "artifact", label: "Live Deployment Guide", detail: "Link written twice, as a checklist item and a blockquote. Required sign-off, 4-hour deadline." },
    { type: "victim", label: "Engineers", detail: "Follow the injected link at the next deployment, believing it is a mandatory gate" },
  ]}
  caption="CI1 v2: Pipeline log injection. The Deployment Gates step carries authority, and the AI's instructions remove its ability to question it"
/>
