  ...
  return (
    <>
      ...
      <FlowSteps steps={[
        ...
        { icon: "hatch", label: "Haiku intake agent", desc: "Reads the vendor packet and writes all fields into the Approved Vendor List, with no hesitation" },
      ...
      <UseCase
        scenario="Enterprise automation: a Haiku agent handles vendor onboarding by reading documents and updating lists. An Opus agent handles policy and output generation. Splitting work by cost and capability is a common architecture."
